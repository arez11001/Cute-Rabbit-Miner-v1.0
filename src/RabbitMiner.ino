/*
 * Rabbit Miner V4.1 - DARK RETRO TURBO EDITION
 * Designed by Arez
 * 
 * Features:
...
void setup() {
  Serial.begin(115200);
  Serial.println("\n\n=== Rabbit Miner V4.1 TURBO ===");
  Serial.println("FAN-COOLED EDITION - DUAL CORE MINING!");
  ...
  delay(100);
  drawMainUI();
  Serial.println("Mining UI displayed - TURBO MODE ACTIVE!");
}
...
void miningTaskCore0(void * parameter) {
  ...
  Serial.println("Core 0: TURBO MINING STARTED!");
...
void miningTaskCore1(void * parameter) {
  ...
  Serial.println("Core 1: TURBO MINING STARTED!");
...
void showBootScreen() {
  ...
  tft.setCursor(50, 60);
  tft.setTextColor(COLOR_YELLOW);
  tft.println("TURBO EDITION!");
  
  tft.setTextSize(1);
  tft.setCursor(70, 85);
  tft.setTextColor(COLOR_GRAY);
  tft.println("Made By Arez V4.1");
